...
const (
	AgentService_Connect_FullMethodName = "/lotsman.v1.AgentService/Connect"
)
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "lotsman.v1.AgentService",
